QUnit.test("Roman Numeral Converter", function(assert) {
  ...
  assert.equal(convertRomanToInteger("CCXL").value, 240, "TC-1: Convert 'CCXL' to 240");
  assert.equal(convertRomanToInteger("MDCL").value, 1650, "TC-2: Convert 'MDCL' to 1650");
  assert.equal(convertRomanToInteger("DCCCLXXVIII").value, 878, "TC-3: Convert 'DCCCLXXVIII' to 878");
  assert.equal(convertRomanToInteger("XLV").value, 45, "TC-4: Convert 'XLV' to 45");
  assert.equal(convertRomanToInteger("MMMDCCXLII").value, 3742, "TC-5: Convert 'MMMDCCXLII' to 3742");
  assert.equal(convertRomanToInteger("MMCCCI").value, 2301, "TC-6: Convert 'MMCCCI' to 2301");
