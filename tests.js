test("Correct-FromRoman", function(assert) {
...
test("Incorrect-FromRoman", function(assert) {
...
test("Correct-FromInteger", function(assert) {
...
test("Incorrect-FromInteger", function(assert) {
